        ...
        <form method="POST" action="" enctype="multipart/form-data" class="space-y-5 flex-1">
          ...
          <div>
            <label class="block text-sm font-semibold text-slate-700 mb-2">
              <i class="fa-solid fa-school mr-2 text-primary"></i>Nom de l'école
            </label>
          ...
          <div>
            <label class="block text-sm font-semibold text-slate-700 mb-2">
              <i class="fa-solid fa-location-dot mr-2 text-primary"></i>Adresse complète
            </label>
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <label class="block text-sm font-semibold text-slate-700 mb-2">
                <i class="fa-solid fa-phone mr-2 text-primary"></i>Téléphone
              </label>
            ...
            <div>
              <label class="block text-sm font-semibold text-slate-700 mb-2">
                <i class="fa-solid fa-envelope mr-2 text-primary"></i>Email de contact
              </label>
          ...
          <div>
            <label class="block text-sm font-semibold text-slate-700 mb-2">
              <i class="fa-solid fa-building mr-2 text-primary"></i>Type d'établissement
            </label>
            ...
            <div class="flex flex-wrap gap-6">
              <label class="flex items-center gap-2 cursor-pointer group">
                ...
                <span class="flex items-center gap-1.5 text-sm font-medium text-slate-700 group-hover:text-primary transition-colors">
                  <i class="fa-solid fa-circle-check text-emerald-500"></i> Actif
                </span>
              </label>
              <label class="flex items-center gap-2 cursor-pointer group">
                <input type="radio" name="status" value="inactive" 
                       ...
                       class="radio-status">
                <span class="flex items-center gap-1.5 text-sm font-medium text-slate-700 group-hover:text-primary transition-colors">
                  <i class="fa-solid fa-circle-exclamation text-red-500"></i> Inactif
                </span>
              </label>
            </div>
      ...
      <div class="settings-card bg-white rounded-2xl border border-slate-200/80 shadow-lg shadow-slate-200/50 p-6 sm:p-8">
        ...
        <form method="POST" action="" enctype="multipart/form-data" class="flex flex-col flex-1">
          <div id="logo-preview" class="mb-6 w-full rounded-2xl bg-gradient-to-br from-slate-100 to-slate-200 border-2 border-dashed border-slate-300 flex items-center justify-center overflow-hidden shadow-inner" style="aspect-ratio: 16/9;">
            ...
            <?php else: ?>
              <i class="fa-solid fa-image text-6xl text-slate-400"></i>
            <?php endif; ?>
          </div>
          ...
          <div class="mt-6 p-4 bg-gradient-to-r from-primary/5 to-accent/5 rounded-xl">
            <div class="flex gap-2">
              <i class="fa-solid fa-circle-info text-primary text-lg flex-shrink-0 mt-0.5"></i>
