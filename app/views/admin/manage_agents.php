  ...
  <div class="min-h-screen lg:pl-[260px]">
    ...
    <main class="px-4 py-6 sm:px-6 lg:px-8">
      <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <button type="button" id="btn-open-create" class="inline-flex items-center justify-center gap-2 rounded-xl bg-primary px-5 py-3 text-sm font-semibold text-white shadow-lg shadow-primary/25 transition hover:bg-emerald-800">
    ...
    <div id="modal-panel" class="modal-panel relative max-h-[92vh] w-full max-w-2xl overflow-y-auto rounded-2xl border border-slate-200 bg-white shadow-2xl" role="dialog" aria-modal="true" aria-labelledby="modal-title">
      ...
      <form id="agent-form" class="px-5 py-4 sm:px-6 sm:py-5" novalidate>
        ...
        <div class="mt-6 flex flex-col-reverse gap-3 border-t border-slate-100 pt-5 sm:flex-row sm:justify-end">
          ...
          <button type="submit" id="btn-save-agent" class="rounded-xl bg-primary px-5 py-2.5 text-sm font-semibold text-white transition hover:bg-emerald-800 disabled:opacity-60">
            Enregistrer
          </button>
        </div>
      </form>
        ...
        tb.innerHTML = list.map(a => {
          ...
          return `
            <tr class="hover:bg-emerald-50/40">
              ...
              <td class="px-3 py-3"><span class="rounded-full bg-emerald-100 px-2 py-0.5 text-xs font-semibold text-primary">${a.role}</span></td>
